...
const applicationFields: Field[] = [
  ...
  { name: 'first_name', type: 'input', label: 'First Name', required: true, readOnly: false },
  { name: 'last_name', type: 'input', label: 'Last Name', required: true, readOnly: false },
  { name: 'company', type: 'input', label: 'Current Company', required: false, readOnly: false },
  { name: 'title', type: 'input', label: 'Current Title', required: false, readOnly: false },
  ...
  { name: 'address_value', type: 'input', label: 'Address', required: false, readOnly: false },
  ...
  { name: 'website_value', type: 'input', label: 'Website URL', required: false, readOnly: false },
  
  { name: 'social_media', type: 'input', label: 'Social Media Profiles', required: false, readOnly: false },
