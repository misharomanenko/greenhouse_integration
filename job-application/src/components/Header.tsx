    ...
    <header className="bg-white dark:bg-gray-800 shadow-md fixed top-0 left-0 right-0 z-50 w-full">
      <div className="container mx-auto px-4 py-2 flex justify-between items-center">
        ...
        <div className="relative">
          ...
          {showUserInfo && (
            <div className="absolute right-0 mt-2 w-64 bg-white dark:bg-gray-700 rounded-md shadow-lg py-1 z-10">
              <div className="px-4 py-2 text-sm text-gray-700 dark:text-gray-200 break-words">
